"""
Base settings for Acta_backend project.
...
# Email Configuration
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@acta.com')
EMAIL_FROM_NAME = config('EMAIL_FROM_NAME', default='Acta')
...
EMAIL_BACKEND = (
    "accounts.email_backend.ResendEmailBackend"
...
CELERY_BROKER_TRANSPORT_OPTIONS = {
    'max_connections': config('CELERY_BROKER_MAX_CONNECTIONS', default=10, cast=int),
}
